...
%define mmn 20051115
%define vstring Cloud Linux
%define mpms worker event

Summary: Apache HTTP Server
Name: httpd
Version: 2.2.15
Release: 15.el6.cloudlinux.webhost
...
# CloudLinux 
Patch811: apache2.2-mpm-itk-seculrelve.patch
# 
License: ASL 2.0
...
# Build everything and the kitchen sink with the itk build
mpmbuild itk \
        --enable-mods-shared=all \
	--enable-ssl --with-ssl \
	--enable-proxy \
...
* Fri May 20 2011 CloudLinux Packaging Team <packager@cloudlinux.com> - 2.2.15-9
- trademark changed
