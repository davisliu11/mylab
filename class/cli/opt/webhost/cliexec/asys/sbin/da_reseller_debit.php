...
DEFINE("CLIEXEC_DESC",	"Debit a reseller account");
...
while (!isset($reason) || $reason=="") {
	echo "Enter the reason for the debit (DON'T PUT THE TICKET ID HERE): \n";
	$stdin_fp = fopen("php://stdin","r");
...
asysexec("/usr/bin/php /home/asys/controlpanel/lib/dag/scripts/reseller_debit.php ".$username." ".$amount." \"".escapeshellcmd($reason)."\"");
?>
